...
const services = [
  {
    ...
    description:
      "Custom web applications built with modern technologies like React, Next.js, and TypeScript. Responsive, fast, and SEO-optimized.",
    features: [
  ...
  },
  {
    ...
    description:
      "Scalable cloud infrastructure and DevOps solutions on AWS, ensuring high availability and performance.",
    features: [
  ...
  },
  {
    ...
    description:
      "Robust backend systems with secure APIs, database design, and microservices architecture.",
    features: [
  ...
  //   description:
  //     "Optimize your applications for speed, scalability, and user experience across all platforms.",
  //   features: [
  //     "Code Optimization",
  //     "Database Tuning",
  //     "CDN Implementation",
...
const technologies = [
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8 mb-3 mx-auto text-blue-400"
        fill="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8 mb-3 mx-auto text-green-500"
        fill="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8 mb-3 mx-auto text-red-500"
        fill="currentColor"
      >
  ...
  },
  {
    ...
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="h-8 w-8 mb-3 mx-auto text-pink-500"
        fill="currentColor"
      >
        ...
        <div className="container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              ...
              business needs. From web applications to mobile apps, cloud
              infrastructure, and staffing solutions.
            </p>
            <Link
              href="/contact"
        ...
        <div className="container-max section-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              End-to-end software development and staffing services to help your
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-background rounded-lg border p-8 hover:shadow-lg transition-all duration-300"
              >
        ...
        <div className="container-max section-padding">
          ...
          <div className="grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="bg-background rounded-lg border p-4 text-center hover:border-primary/20 transition-colors hover:shadow-md group"
              >
      ...
      <section className="py-20 bg-secondary/5">
        <div className="container-max section-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We follow a proven development methodology to ensure project
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                title: "Development",
                description:
                  "Building your solution using agile development methodology",
              },
              {
                step: "04",
                title: "Deployment",
                description:
                  "Testing, deployment, and ongoing support & maintenance",
              },
            ].map((process, index) => (
