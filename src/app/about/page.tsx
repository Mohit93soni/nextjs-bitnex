...
const values = [
  {
    ...
    title: "Innovation",
    description:
      "We embrace cutting-edge technologies and creative solutions to solve complex problems and drive digital transformation.",
  },
  {
  ...
  },
  {
    ...
    title: "Passion",
    description:
      "We're passionate about technology and its potential to create positive impact in businesses and communities.",
  },
];
...
const team = [
  {
    ...
    role: "Founder",
    description:
      "Founder overseeing vision, product strategy, and company culture.",
  ...
  },
  {
    ...
    role: "CEO",
    description:
      "Leads operations, client relationships, and business growth across Bitnex Infotech.",
    image: "/placeholder.svg",
  },
  {
    name: "Rahul Kumar",
    role: "CTO",
    description:
      "Heads engineering, technical strategy, and architecture across web and mobile platforms.",
    image: "/placeholder.svg",
  },
  {
    name: "Dinesh Kumar",
    role: "Head HR",
    description:
      "Leads talent acquisition, people operations, and a high-performance culture.",
    image: "/placeholder.svg",
  },
];
...
const milestones = [
  {
    ...
    description:
      "Bitnex Infotech was established with a vision to provide innovative software solutions.",
  },
  {
    year: "2024",
    title: "First Major Client",
    description:
      "Secured our first enterprise client and delivered a successful e-commerce platform.",
  },
  {
    year: "2024",
    title: "Team Expansion",
    description: "Grew our team to 25 members and expanded service offerings.",
  },
  {
    year: "2024",
    title: "Cloud Expertise",
    description:
      "Launched cloud migration and DevOps services with strong AWS expertise.",
  },
  {
    year: "2024",
    title: "Mobile Focus",
    description:
      "Expanded into mobile app development with React Native and Flutter.",
  },
  {
    year: "2025",
    title: "20+ Projects",
    description:
      "Reached milestone of 20+ successful projects and 10+ satisfied clients.",
  },
];
        ...
        <div className="container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              ...
              dedicated to building exceptional software solutions that drive
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                At Bitnex Infotech, our mission is to empower businesses through
                innovative technology solutions. We believe that well-crafted
                software can transform the way organizations operate,
                communicate, and serve their customers.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                We combine technical expertise with creative problem-solving to
                deliver solutions that are not only functional but also
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Building solutions that make a difference worldwide
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container-max section-padding">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              <div
                key={index}
                className="text-center bg-background rounded-lg p-6 border"
              >
      ...
      <section className="py-20 bg-secondary/5">
        <div className="container-max section-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              From a small startup to a growing software development company,
              here's our story.
            </p>
          </div>
        ...
        <div className="container-max section-padding">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              We'd love to learn about your project and discuss how we can help
