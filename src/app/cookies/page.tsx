...
export const metadata: Metadata = {
  ...
  description: 'Cookie Policy for Bitnex Infotech. Learn about how we use cookies and tracking technologies on our website.',
  keywords: 'cookie policy, cookies, tracking, website analytics, bitnex infotech',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                We use cookies to improve your experience on our website and to help us understand how our site is being used. 
            ...
            <section className="mb-8">
              ...
              <div className="mb-6">
                ...
                <p className="mb-3">
                  These cookies are necessary for the website to function properly. They cannot be disabled in our systems.
                </p>
                <ul className="list-disc pl-6 mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li><a href="http://optout.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Network Advertising Initiative Opt-out</a></li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                ...
                <li><strong>Persistent cookies:</strong> Remain for a set period (usually 1-24 months)</li>
