...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Bitnex Infotech. Read our terms and conditions for using our software development services.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="mb-4">
              By accessing and using Bitnex Infotech's services, you accept and agree to be bound by the terms and provision of this agreement. 
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Bitnex Infotech provides software development services including but not limited to:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Upon full payment, clients will receive ownership of custom-developed code and materials, 
                excluding pre-existing intellectual property and third-party components.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                In no event shall Bitnex Infotech be liable for any indirect, incidental, special, consequential, 
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                We respect the confidentiality of client information and will not disclose proprietary 
